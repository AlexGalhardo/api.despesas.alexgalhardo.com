...
CREATE TABLE "users" (
    ...
    "asaas_customer_response" TEXT NOT NULL,
    "jwe_token" TEXT,
    "subscription_tier_free" BOOLEAN NOT NULL DEFAULT true,
    "subscription_tier_basic" BOOLEAN NOT NULL DEFAULT false,
    "subscription_tier_pro" BOOLEAN NOT NULL DEFAULT false,
...
-- CreateIndex
CREATE UNIQUE INDEX "users_asaas_customer_response_key" ON "users"("asaas_customer_response");

-- CreateIndex
CREATE UNIQUE INDEX "users_jwe_token_key" ON "users"("jwe_token");
